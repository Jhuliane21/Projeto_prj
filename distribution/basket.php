...
<html>
  ...
  <?php
              ...
              if(isset($_GET["codigo"])){
                ...
                $query1 = "SELECT nome, preco,descricao, codigo, foto FROM produto WHERE codigo = '$codigo'";
                
                $produto = mysqli_query($conn2, $query1);
                $nome ="";
                $preco = 0;
                ...
                $query2 = "INSERT INTO carrinho (Nome, Preco) values('$nome', '$preco')";
                $insert = $conn->prepare($query2);
                $insert->bindParam(':nome', $nome);
                $insert->bindParam(':preco', $preco);
                $insert->execute();
              }
                $query = "SELECT Nome, Preco FROM carrinho";
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="nav-item"><a href="index.html" class="nav-link active">Home</a></li>
                  <li aria-current="page" class="breadcrumb-item active">Carrinho</li>
                </ol>
              </nav>
            </div>
              ...
              <div class="box">
                <form method="post" action="checkout1.html">
                    ...
                    <table class="table">
                      ...
                      //echo "<tbody>";
                        echo "<tr>";
                          ...
                          echo "<td><a href='#'>".$item["Nome"]."</a></td>";
                         
                          echo "<td>R$ ".$item["Preco"].",00</td>";
                      ...
                      ?>
                        <tr>
                         ...
                         <?php echo "<th colspan='2'>R$ ".$total.",00</th>";?>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
                  ...
                  <div class="box-footer d-flex justify-content-between flex-column flex-lg-row">
                    <div class="left"><a onclick="javascript: location.href='category.php?categoria=Base'" ><i class="fa fa-chevron-left"></i> Continuar Comprando</a></div>
                    <div class="right">
                      <button class="btn btn-outline-secondary"><i class="fa fa-refresh"></i> Atualizar</button>
